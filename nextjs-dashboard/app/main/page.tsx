...
export default function Page() {
  ...
  <div className="min-h-28 ">
    <div className="max-w-screen-lg mx-auto py-4">
      ...
      <p className="text-center mt-4 font-medium text-slate-500">- Place to grow -</p>
      ...
      <div className="rounded-lg overflow-hidden mt-10 relative before:absolute before:z-20 before:bg-black before:h-full before:w-full before:bg-gradient-to-tr before:from-black before:to-emerald-600 before:opacity-80">
        <img src="https://loremflickr.com/320/240?random=1" className="absolute z-10 object-cover h-80 w-full h-full" alt=""/>
        <a href="./main" className="absolute z-20  top-1/2  right-20 text-white -translate-y-1/2">
        ...
        <div className="relative z-20 p-10 h-full w-1/2">
          <h2 className="text-white text-3xl font-semibold">How to study math?</h2>
          <h3 className="text-white text-xl">Math is good</h3>
          <p className="text-sm text-slate-200 mt-4">
            To study math you need to...
          </p>
          <div className="flex gap-4 items-center pt-4 border-t border-slate-300 text-slate-300 mt-6">
              ...
              <span className="flex gap-1 items-center text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="text-sky-400 w-4 h-4">
